...
public final class WorldMetricRegistry {
    private static final List<WorldMetricDefinition> DEFINITIONS = List.of(
            ...
            new WorldMetricDefinition(WorldMetricId.FOOD_SPAWNED_PER_SEC, "Food Spawned/Tick", "per tick",
                    new Color(80, 190, 255), WorldMetricCategory.FOOD,
                    ctx -> ctx.foodSpawnedPerSec()),
            new WorldMetricDefinition(WorldMetricId.FOOD_CONSUMED_PER_SEC, "Food Consumed/Tick", "per tick",
            ...
            new WorldMetricDefinition(WorldMetricId.FOOD_SPAWN_RATE, "Food Spawn / Tick", "per tick",
